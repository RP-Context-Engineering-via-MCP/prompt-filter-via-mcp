    ...
    return (
        <div className="flex h-screen bg-white font-sans text-black">
            ...
            <aside className="hidden md:flex flex-col w-[260px] bg-gray-50 border-r border-gray-200 p-4">
                ...
                <button className="flex items-center gap-2 w-full px-3 py-2 bg-gray-200 hover:bg-gray-300 rounded-lg transition-colors text-sm font-medium mb-4">
                ...
                <div className="flex-1 overflow-y-auto">
                    ...
                    {/* Mock history items */}
                    {['React Interface Design', 'Tailwind CSS Tips', 'Weather in Tokyo'].map((item, i) => (
                        <div key={i} className="px-3 py-2 rounded-lg hover:bg-stone-200/50 cursor-pointer text-sm truncate text-stone-600">
                            {item}
                        </div>
                    ))}
                </div>
