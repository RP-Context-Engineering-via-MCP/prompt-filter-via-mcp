        ...
        <header className="flex items-center justify-between px-6 py-4 bg-memora-bg border-b border-slate-100 z-10 flex-shrink-0">
            ...
            <div className="flex items-center gap-3">
                ...
                <div 
                    ...
                    title="View MCP Access Token"
                >
                    <div className="text-right hidden sm:block">
                        <div className="text-xs font-bold text-slate-800 leading-tight">Alex Rivera</div>
                        <div className="text-[9px] font-bold text-emerald-500 uppercase tracking-widest mt-0.5">Security Lead</div>
                    </div>
                ...
                <button
                    ...
                    title="Connect external LLM client"
                    className="flex items-center gap-1.5 px-3 py-2 bg-slate-800 text-white rounded-xl hover:bg-slate-700 shadow-sm hover:shadow-md transition-all duration-200 text-xs font-bold"
                >
